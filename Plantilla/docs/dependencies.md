---
layout: page
title: Dependencies & ../Plantilla/plugins
---
#### Dependencies
...
- [All other ../Plantilla/plugins are listed below](#../Plantilla/plugins)

<a id="../Plantilla/plugins" class="anchor"></a>
#### ../Plantilla/plugins
{: .mt-4 .anchor}

AdminLTE makes use of the following ../Plantilla/plugins. For documentation, updates or license information, please visit the provided links.
{: .lead}

> Note!
> You need to load the js/css files of the plugin that you want to use.
> AdminLTE doesn't load automatically all ../Plantilla/plugins, this would cause huge load times on every page load.
{:.quote-warning}
...
<div class="row px-3">
  ...
  <div class="col-sm-3">
    <ul class="list-unstyled">
      ...
      <li><a href="http://ionden.com/a/../Plantilla/plugins/ion.rangeSlider/" target="_blank">Ion.RangeSlider</a></li>
