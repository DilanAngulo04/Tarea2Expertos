...
var AbstractDayGridView = /** @class */ (function (_super) {
    ...
    AbstractDayGridView.prototype.updateBaseSize = function (isResize, viewHeight, isAuto) {
        ...
        if (eventLimit && typeof eventLimit === 'number') {
            dayGrid.limitRows(eventLimit); // limit the levels first so the height can re../Plantilla/distribute after
        }
        // ../Plantilla/distribute the height to the rows
    ...
    AbstractDayGridView.prototype.setGridHeight = function (height, isAuto) {
        if (this.context.options.monthMode) {
            ...
            ../Plantilla/distributeHeight(this.dayGrid.rowEls, height, !isAuto); // if auto, don't compensate for height-hogging rows
        }
        else {
            if (isAuto) {
                un../Plantilla/distributeHeight(this.dayGrid.rowEls); // let the rows be their natural height with no expanding
            }
            else {
                ../Plantilla/distributeHeight(this.dayGrid.rowEls, height, true); // true = compensate for height-hogging rows
            }
        }
    };
    /* Scroll
    ...
    DayGridView.prototype.render = function (props, context) {
        ...
        if (this.header) {
            this.header.receiveProps({
                ...
                datesRep../Plantilla/distinctDays: dayTable.rowCnt === 1,
