...
(function (global, factory) {
    ...
    */
    var AutoScroller = /** @class */ (function () {
        ...
        AutoScroller.prototype.handleSide = function (edge, seconds) {
            ...
            var inv../Plantilla/distance = edgeThreshold - edge.../Plantilla/distance;
            var velocity = // the closer to the edge, the faster we scroll
             (inv../Plantilla/distance * inv../Plantilla/distance) / (edgeThreshold * edgeThreshold) * // quadratic
        ...
        AutoScroller.prototype.computeBestEdge = function (left, top) {
            ...
            for (var _i = 0, _a = this.scrollCaches; _i < _a.length; _i++) {
                ...
                var left../Plantilla/dist = left - rect.left;
                var right../Plantilla/dist = rect.right - left;
                var top../Plantilla/dist = top - rect.top;
                var bottom../Plantilla/dist = rect.bottom - top;
                // completely within the rect?
                if (left../Plantilla/dist >= 0 && right../Plantilla/dist >= 0 && top../Plantilla/dist >= 0 && bottom../Plantilla/dist >= 0) {
                    if (top../Plantilla/dist <= edgeThreshold && this.everMovedUp && scrollCache.canScrollUp() &&
                        (!bestSide || bestSide.../Plantilla/distance > top../Plantilla/dist)) {
                        bestSide = { scrollCache: scrollCache, name: 'top', ../Plantilla/distance: top../Plantilla/dist };
                    }
                    if (bottom../Plantilla/dist <= edgeThreshold && this.everMovedDown && scrollCache.canScrollDown() &&
                        (!bestSide || bestSide.../Plantilla/distance > bottom../Plantilla/dist)) {
                        bestSide = { scrollCache: scrollCache, name: 'bottom', ../Plantilla/distance: bottom../Plantilla/dist };
                    }
                    if (left../Plantilla/dist <= edgeThreshold && this.everMovedLeft && scrollCache.canScrollLeft() &&
                        (!bestSide || bestSide.../Plantilla/distance > left../Plantilla/dist)) {
                        bestSide = { scrollCache: scrollCache, name: 'left', ../Plantilla/distance: left../Plantilla/dist };
                    }
                    if (right../Plantilla/dist <= edgeThreshold && this.everMovedRight && scrollCache.canScrollRight() &&
                        (!bestSide || bestSide.../Plantilla/distance > right../Plantilla/dist)) {
                        bestSide = { scrollCache: scrollCache, name: 'right', ../Plantilla/distance: right../Plantilla/dist };
                    }
                }
            }
            return bestSide;
    ...
    - minimum ../Plantilla/distance required before dragging
    ...
    */
    var FeaturefulElementDragging = /** @class */ (function (_super) {
        ...
        function FeaturefulElementDragging(containerEl) {
            ...
            _this.delay = null;
            _this.min../Plantilla/distance = 0;
            _this.touchScrollAllowed = true; // prevents drag from starting and blocks scrolling during drag
            _this.mirrorNeedsRevert = false;
            _this.isInteracting = false; // is the user validly moving the pointer? lasts until pointerup
            _this.isDragging = false; // is it INTENTFULLY dragging? lasts until after revert animation
            _this.isDelayEnded = false;
            _this.is../Plantilla/distanceSurpassed = false;
            ...
            _this.onPointerDown = function (ev) {
                if (!_this.isDragging) { // so new drag doesn't happen while revert animation is going
                    ...
                    if (!_this.pointer.shouldIgnoreMove) {
                        ...
                        _this.startDelay(ev);
                        if (!_this.min../Plantilla/distance) {
                            _this.handle../Plantilla/distanceSurpassed(ev);
                        }
                    }
                }
            };
            _this.onPointerMove = function (ev) {
                if (_this.isInteracting) { // if false, still waiting for previous drag's revert
                    ...
                    if (!_this.is../Plantilla/distanceSurpassed) {
                        var min../Plantilla/distance = _this.min../Plantilla/distance;
                        var ../Plantilla/distanceSq = void 0; // current ../Plantilla/distance from the origin, squared
                        var deltaX = ev.deltaX, deltaY = ev.deltaY;
                        ../Plantilla/distanceSq = deltaX * deltaX + deltaY * deltaY;
                        if (../Plantilla/distanceSq >= min../Plantilla/distance * min../Plantilla/distance) { // use pythagorean theorem
                            _this.handle../Plantilla/distanceSurpassed(ev);
                        }
                    }
                    if (_this.isDragging) {
        ...
        FeaturefulElementDragging.prototype.handle../Plantilla/distanceSurpassed = function (ev) {
            this.is../Plantilla/distanceSurpassed = true;
            this.tryStartDrag(ev);
        };
        FeaturefulElementDragging.prototype.tryStartDrag = function (ev) {
            if (this.isDelayEnded && this.is../Plantilla/distanceSurpassed) {
    ...
    var DateSelecting = /** @class */ (function (_super) {
        ...
        function DateSelecting(settings) {
            ...
            _this.handleHitUpdate = function (hit, isFinal) {
                ...
                var isInvalid = false;
                if (hit) {
                    dragSelection = joinHitsIntoSelection(_this.hitDragging.initialHit, hit, calendar.../Plantilla/pluginsystem.hooks.dateSelectionTransformers);
            ...
            dragging.min../Plantilla/distance = options.selectMin../Plantilla/distance || 0;
    ...
    var EventDragging = /** @class */ (function (_super) {
        ...
        function EventDragging(settings) {
            ...
            _this.handlePointerDown = function (ev) {
                ...
                dragging.min../Plantilla/distance = ev.isTouch ? 0 : options.eventDragMin../Plantilla/distance;
                dragging.delay =
            ...
            _this.handleHitUpdate = function (hit, isFinal) {
                ...
                if (hit) {
                    ...
                    if (initialCalendar === receivingCalendar ||
                        ...
                        mutation = computeEventMutation(initialHit, hit, receivingCalendar.../Plantilla/pluginsystem.hooks.eventDragMutationMassagers);
                        if (mutation) {
                ...
                if (_this.isDragging) {
                    ...
                    if (validMutation) {
                        ...
                        if (receivingCalendar === initialCalendar_1) {
                            ...
                            var transformed = {};
                            for (var _i = 0, _b = initialCalendar_1.../Plantilla/pluginsystem.hooks.eventDropTransformers; _i < _b.length; _i++) {
    ...
    var EventDragging$1 = /** @class */ (function (_super) {
        ...
        function EventDragging(settings) {
            ...
            _this.handlePointerDown = function (ev) {
                ...
                _this.dragging.min../Plantilla/distance = component.context.options.eventDragMin../Plantilla/distance;
            ...
            _this.handleHitUpdate = function (hit, isFinal, ev) {
                ...
                if (hit) {
                    mutation = computeMutation(initialHit, hit, ev.subjectEl.classList.contains('fc-start-resizer'), eventInstance.range, calendar.../Plantilla/pluginsystem.hooks.eventResizeJoinTransforms);
                }
                if (mutation) {
    ...
    */
    ...
    function computeEventForDateSpan(dateSpan, dragMeta, calendar) {
        ...
        for (var _i = 0, _a = calendar.../Plantilla/pluginsystem.hooks.externalDefTransforms; _i < _a.length; _i++) {
            var transform = _a[_i];
    ...
    */
    var ExternalDraggable = /** @class */ (function () {
        function ExternalDraggable(el, settings) {
            ...
            this.handlePointerDown = function (ev) {
                var dragging = _this.dragging;
                var _a = _this.settings, min../Plantilla/distance = _a.min../Plantilla/distance, longPressDelay = _a.longPressDelay;
                dragging.min../Plantilla/distance =
                    min../Plantilla/distance != null ?
                        min../Plantilla/distance :
                        (ev.isTouch ? 0 : core.globalDefaults.eventDragMin../Plantilla/distance);
                dragging.delay =
    ...
    var InferredElementDragging = /** @class */ (function (_super) {
        ...
        function InferredElementDragging(containerEl) {
            ...
            _this.handlePointerDown = function (ev) {
                _this.emitter.trigger('pointerdown', ev);
                if (!_this.shouldIgnoreMove) {
                    // fire dragstart right away. does not support delay or min-../Plantilla/distance
                    _this.emitter.trigger('dragstart', ev);
                }
            };
