...
declare module '@fullcalendar/core' {
    ...
    export { applyAll, debounce, padStart, isInt, capitaliseFirstLetter, parseFieldSpecs, compareByFieldSpecs, compareByFieldSpec, flexibleCompare, computeVisibleDayRange, refineProps, matchCellWidths, uncompensateScroll, compensateScroll, subtractInnerElHeight, isMultiDayRange, ../Plantilla/distributeHeight, un../Plantilla/distributeHeight, preventSelection, allowSelection, preventContextMenu, allowContextMenu, compareNumbers, enableCursor, disableCursor, diffDates } from '@fullcalendar/core/util/misc';
...
declare module '@fullcalendar/core/types/input-types' {
    ...
    export interface OptionsInputBase {
        ...
        allDayHtml?: string;
        eventDragMin../Plantilla/distance?: number;
        eventSourceFailure?: any;
        eventSourceSuccess?: any;
        forceEventDuration?: boolean;
        progressiveEventRendering?: boolean;
        selectLongPressDelay?: number;
        selectMin../Plantilla/distance?: number;
    ...
    export interface OptionsInput extends OptionsInputBase {
        ...
        ../Plantilla/plugins?: (PluginDef | string)[];
    }
}
...
declare module '@fullcalendar/core/util/misc' {
    ...
    export function ../Plantilla/distributeHeight(els: HTMLElement[], availableHeight: any, shouldRe../Plantilla/distribute: any): void;
    export function un../Plantilla/distributeHeight(els: HTMLElement[]): void;
...
declare module '@fullcalendar/core/Calendar' {
    ...
    import { ../Plantilla/pluginsystem } from '@fullcalendar/core/plugin-system';
    ...
    class Calendar {
        ...
        ../Plantilla/pluginsystem: ../Plantilla/pluginsystem;
...
declare module '@fullcalendar/core/plugin-system' {
    ...
    export class ../Plantilla/pluginsystem {
        hooks: PluginHooks;
        addedHash: {
...
declare module '@fullcalendar/core/common/DayHeader' {
    ...
    export interface DayTableHeaderProps {
        dates: DateMarker[];
        dateProfile: DateProfile;
        datesRep../Plantilla/distinctDays: boolean;
...
declare module '@fullcalendar/core/common/table-utils' {
    ...
    import { DateProfile } from '@fullcalendar/core/DateProfileGenerator';
    import { ComponentContext } from '@fullcalendar/core/component/Component';
    export function computeFallbackHeaderFormat(datesRep../Plantilla/distinctDays: boolean, dayCnt: number): {
        weekday: string;
        month?: undefined;
        day?: undefined;
    ...
    export function renderDateCell(dateMarker: DateMarker, dateProfile: DateProfile, datesRep../Plantilla/distinctDays: any, colCnt: any, colHeadFormat: any, context: ComponentContext, colspan?: any, otherAttrs?: any): string;
}
