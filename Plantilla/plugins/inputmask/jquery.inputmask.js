/*!
 * ../Plantilla/dist/jquery.inputmask
        ...
        module.exports = function maskScope(actionObj, maskset, opts) {
            ...
            function determineTestTemplate(pos, tests) {
                ...
                for (var altTest = getTest(pos), targetLocator = getLocator(altTest), tstLocator, closest, bestMatch, ndx = 0; ndx < tests.length; ndx++) {
                    ...
                    var ../Plantilla/distance = Math.abs(tstLocator - targetLocator);
                    (void 0 === closest || "" !== tstLocator && ../Plantilla/distance < closest || bestMatch && !opts.greedy && bestMatch.match.optionality && "master" === bestMatch.match.newBlockMarker && (!tst.match.optionality || !tst.match.newBlockMarker) || bestMatch && bestMatch.match.optionalQuantifier && !tst.match.optionalQuantifier) && (closest = ../Plantilla/distance, 
                    bestMatch = tst);
                }
                return bestMatch;
            }
