...
(function(window, $, undefined) {
    ...
    var JSGRID = "JSGrid",
        ...
        ../Plantilla/pages_PLACEHOLDER = "{../Plantilla/pages}",
    ...
    Grid.prototype = {
        ...
        pagerContainer: null,
        pageIndex: 1,
        ../Plantilla/pagesize: 20,
        pageButtonCount: 15,
        pagerFormat: "../Plantilla/pages: {first} {prev} {../Plantilla/pages} {next} {last} &nbsp;&nbsp; {pageIndex} of {pageCount}",
        pagePrevText: "Prev",
        pageNextText: "Next",
        pageFirstText: "First",
        pageLastText: "Last",
        ...
        _../Plantilla/pagesCount: function() {
            var itemsCount = this._itemsCount(),
                ../Plantilla/pagesize = this.../Plantilla/pagesize;
            return Math.floor(itemsCount / ../Plantilla/pagesize) + (itemsCount % ../Plantilla/pagesize ? 1 : 0);
        },
        ...
        _refreshPager: function() {
            ...
            var showPager = this.paging && this._../Plantilla/pagesCount() > 1;
        ...
        _createPager: function() {
            ...
            if($.isFunction(this.pagerRenderer)) {
                $result = $(this.pagerRenderer({
                    ...
                    pageCount: this._../Plantilla/pagesCount()
                }));
            } else {
        ...
        _createPagerByFormat: function() {
            ...
            return $.map(pagerParts, $.proxy(function(pagerPart) {
                ...
                if(pagerPart === ../Plantilla/pages_PLACEHOLDER) {
                    result = this._create../Plantilla/pages();
        ...
        _create../Plantilla/pages: function() {
            var pageCount = this._../Plantilla/pagesCount(),
                pageButtonCount = this.pageButtonCount,
                firstDisplayingPage = this._firstDisplayingPage,
                ../Plantilla/pages = [];

            if(firstDisplayingPage > 1) {
                ../Plantilla/pages.push(this._createPagerPageNavButton(this.pageNavigatorPrevText, this.showPrev../Plantilla/pages));
            }

            for(var i = 0, pageNumber = firstDisplayingPage; i < pageButtonCount && pageNumber <= pageCount; i++, pageNumber++) {
                ../Plantilla/pages.push(pageNumber === this.pageIndex
                    ? this._createPagerCurrentPage()
                    : this._createPagerPage(pageNumber));
            }

            if((firstDisplayingPage + pageButtonCount - 1) < pageCount) {
                ../Plantilla/pages.push(this._createPagerPageNavButton(this.pageNavigatorNextText, this.showNext../Plantilla/pages));
            }

            return ../Plantilla/pages;
        },
        ...
        showPrev../Plantilla/pages: function() {
        ...
        showNext../Plantilla/pages: function() {
            var firstDisplayingPage = this._firstDisplayingPage,
                pageButtonCount = this.pageButtonCount,
                pageCount = this._../Plantilla/pagesCount();
        ...
        openPage: function(pageIndex) {
            if(pageIndex < 1 || pageIndex > this._../Plantilla/pagesCount())
                return;
...
(function(jsGrid, $, undefined) {
    ...
    DirectLoadingStrategy.prototype = {
        ...
        firstDisplayIndex: function() {
            var grid = this._grid;
            return grid.option("paging") ? (grid.option("pageIndex") - 1) * grid.option("../Plantilla/pagesize") : 0;
        },
        ...
        lastDisplayIndex: function() {
            ...
            return grid.option("paging")
                ? Math.min(grid.option("pageIndex") * grid.option("../Plantilla/pagesize"), itemsCount)
                : itemsCount;
        },
    ...
    PageLoadingStrategy.prototype = {
        ...
        loadParams: function() {
            ...
            return {
                ...
                ../Plantilla/pagesize: grid.option("../Plantilla/pagesize")
            };
        },
